...
<html>
  ...
  <body>
    ...
    <div id="main" class="webtv webtv-ba loading">
     <div class="bandeau">
      <div id="live" style="background-image:url(http://dummyimage.com/1920x450/666/fff&text=+)">
        <div class="vCenter">
      ...
      <ul class="sub-nav-list">
        ...
        <li><a href="webtv_trailer_uncertainregard.php" data-url="webtv_trailer_uncertainregard_detail.php" class="active ajax">Un certain regard</a></li>
