...
<body>
  ...
  Imprimer</a>
          ...
          <h2 class="title">Principaux films</h2>
          <div class="best-films">
            <div class="item-film">
              <img src="img/evenements/cover-bestfilm.jpg" alt="">
              <strong class="title">IO SONO UN AUTARCHICO</strong>
              <span class="desc">(Je suis un autarcique)</span>
