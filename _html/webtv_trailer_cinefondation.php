    ...
    <div id="main" class="webtv webtv-ba loading">
     <div class="bandeau">
				...
				<ul class="sub-nav-list">
					...
					<li><a href="webtv_trailer_cinefondation.php" data-url="webtv_trailer_cinefondation.php" class="active ajax">Cinéfondation</a></li>
			...
			<div class="content-webtv">
						<?php include('webtv_trailer_cinefondation_detail.php'); ?>
			</div>
    </div>
