  ...
  <body>
    ...
    <div id="main" class="list-article films-list selection-officielle loading">
      <div class="bandeau-list">
           <div class="bandeau-list-img bandeau-head vCenter" style="background-image:url(http://dummyimage.com/1920x450/bebebe/fff&text=+)">
           ...
           <ul class="sub-nav-list nav-list">
             ...
             <li>
               <a href="selectionofficielle_horscompetition.php" class="ajax active">Hors compétition</a>
             </li>
             <li>
      ...
      <div class="bandeau-list  bandeau-list-footer push-footer vCenter">
           <div class="bandeau-list-img vCenterKid" style="background-image:url(img/films/selection-officielle/push.jpg);">
               <h2 class="title title-list-header">Séances spéciales</h2>
               <a href="selectionofficielle_seancespeciales.php" class="bandeau-lien"> <img src="img/svg/arrow-right-gold.svg" alt="Découvrir la rubrique" class="svg-arrow"> Découvrir la rubrique</a>
           </div>
      </div>
    </div>
