  ...
  <body>
    ...
    <div id="main" class="home loading">    
        ...
        <div class="bigContainer"> 
          <div class="text-presentation boxes conference mdf">
            <h3>Le programme du 10 au 17 mai 2017</h3>
            ...
            <h6>Équipe du film - Photocall - The Lobster © FDC / Théophile Delange</h6>
          </div>
        </div>
        <div class="bigContainer"> 
