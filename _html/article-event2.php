    ...
    <div id="main" class="single-article loading">
      ...
      <div class="content-article">
        <div class="container small-container">
          ...
          <h2 class="title-article">Lorem ipsum</h2>
          <div class="buttons">
          ...
          <div class="info-film">
            <div class="wrapper">
              <div class="vCenter">
                <div class="vCenterKid">
                  <div class="poster">
                    <img src="img/article/008.jpg" alt="" />
                  </div>
                  <div class="text-container">
                    <span class="category">LEÇON DE CINÉMA</span>
                    <h3><a href="#">Marco Bellocchio</a></h3>
                    <p class="director"><a href="#">Marco Bellocchio</a><p>
                    <p>Au cinéma comme en amour,</p>
                    <p>il faut savoir s’abandonner...</p>
                  </div>
                </div>
              </div>
            </div>
