    ...
    <div class="contain-section participate-active">
      ...
      <div class="item-manual">
        ...
        <div class="text-manual">
          ...
          <p class="descrip-manual">
            <strong>Entrée Méditérranée :</strong> accessible à tous les badges professonnels de 9h à 18h30.
          </p>
          <p class="descrip-manual title-descript">
            <strong>Entrée principale (13 au 24 mai) :</strong> accessible à tous les badges professonnels.</p>
          <ul>
            <li>Dès 8h15 pour les projections programmées au Palais avant 9h (porte située à droite)
            </li>
            <li>Jusqu’à 22h30 pour l’accès aux projections Buñuel ou à la salle de Presse et pour les salles Marché. </li>
          </ul>
          <p class="descrip-manual">
            Fermeture de l'accès à la zone d'exposition à 18h30.
          </p>
          <p class="descrip-manual title-descript"><strong>Entrée Riveria (13 au 22 mai) :</strong> pour les badges Marché</p>
          <ul>
            <li>De 9h à 22h45 pour les badges Marché</li>
            <li>De 8h à 21h pour les exposants</li>
    ...
    <div class="contain-section">
      ...
      <div class="item-manual">
        <div class="contain-img">
          ...
          <img src="img/participate/item-manual4.png" alt="">
          <img src="img/participate/item-manual5.png" alt="">
        </div>
        <div class="text-manual accredit">
          <p class="descrip-manual">
            <strong>Localisation :</strong> Palais, niveau 01, entre l'office de tourisme et l'entrée principale du Palais.
          </p>
          <p class="descrip-manual title-descript">
            <strong>Horaires :</strong> du 12 au 14 mai 2015 de 8h à 20h, puis du 15 au 23 mai de 9h à 18h pour les accréditations Festival et Marché.</p>
          <p class="descrip-manual title-descript">
            <strong>ATTENTION :</strong> Accueil des accréditations tardives, Marché et Festival : du 13 au 23 mai, de 9h à 18h.</p>
            <div class="contain-people">
              <div class="people">
                <strong>Responsable Festival</strong>
                <p class="name">Fabrice Allard</p>
                <span class="num">+33 (0)4 92 99 80 57</span>
              </div>
              <div class="people">
                <strong>Responsable Marché</strong>
                <p class="name">David Capaldi</p>
                <span class="num">+33 (0)4 92 99 80 12</span>
              </div>
              <div class="people">
                <strong>Service de Presse</strong>
                <span class="num">+33 (0)4 92 99 81 28</span>
                <span class="num">+33 (0)4 92 99 81 29</span>
              </div>
              <div class="people">
                <strong>Service de Presse audiovisuelle et photographie</strong>
                <span class="num">+33 (0)4 92 99 83 52</span>
              </div>
            </div>
          <strong class="title-item-manual">Retrait du badge</strong>
        ...
        <div class="contain-infos">
          ...
          <div class="item-infos">
            ...
            <div class="descrip">
              ...
              <p><strong>Téléphone :</strong> <span class="phone">+ 33 (0)4 92 98 72 24</span></p>
              <p><strong>Situé :</strong> Gare maritime</p>
            </div>
          </div>
          <div class="item-infos">
            ...
            <div class="descrip">
              ...
              <p><span class="phone">+ 33 (0)4 92 99 26 26</span> ou <span class="phone">25 28</span></p>
              <p><strong>N° d'urgence interne dans le Palais des Festivals <br>depuis un poste du Palais : </strong> <span class="phone">25 28</span></p>
              <p><strong>Accident-Sinistre-Incendie :</strong> <span class="phone">+33 (0)4 92 99 26 26</span> ou <span class="phone">25 28</span></p>
            </div>
          </div>
        </div>
      </div>     
