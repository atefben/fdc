    ...
    <div class="greyBckg"> 
          <div class="bigContainer">    
            <div class="text-presentation boxes">
                <h3>Accédez au meilleur équipement média <br> via le Marché du Film</h3>
                <h5>On sait depuis longtemps que travailler avec du texte lisible et contenant du sens est source de distractions, et empêche de se concentrer sur la mise en page elle-même. L'avantage du Lorem Ipsum sur un texte générique comme du texte.</h5> 
            </div>
        </div>
        <div class="greyBckg"> 
          <div class="bigContainer"> 
              <ul class="tabs">
                <li class="active halfTab" rel="tab1"><h4 class="blueActive">travel & accommodations</h4>Mettez en avant votre société ou votre film</li>
                <li class="halfTab" rel="tab2"><h4 class="blueActive">technical equipment</h4>Maximisez votre visibilité.</li>
              </ul>
            </div>
        </div>
                    ...
                    <div class="minTab">
                      <div class="tabPic">
                          <div class="owl-pub owl-carousel owl-theme">
                              ...
                              <div class="item">
                                <img src="/img/stand.png" alt="Marché du film">
                              </div>
                              <div class="item">
                                <img src="/img/stand.png" alt="Marché du film">
                              </div>
                      ...
                      <div class="tabBox">
                          <span>accès internet et téléphone</span>
                          <h5>se renseigner sur le prix</h5>
