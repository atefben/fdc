    ...
    <div id="main" class="webtv webtv-ba loading">
     <div class="bandeau">
				...
				<ul class="sub-nav-list">
					...
					<li><a href="webtv_trailer_courtmetrage.php" data-url="webtv_trailer_courtmetrage.php" class="active ajax">Courts métrages</a></li>
			...
			<div class="content-webtv">
						<?php include('webtv_trailer_courtmetrage_detail.php'); ?>
			</div>
    </div>
