    ...
    <div id="main" class="all-photos grid">
      ...
      <div id="gridPhotos" class="grid-wrapper">
        ...
        <div class="item theme1 date theme portrait shadow-bottom photo">
          <a id="photo1" class="chocolat-image" href="img/slide002.jpg" title='<h2>Sur le tournage de "Deephan" de Jacques Audiard</h2><p>Crédit Image : VALERY HACHE / AFP</p>'></a>
        ...
        <div class="item theme2 date1 theme shadow-bottom photo">
          <a id="photo2" class="chocolat-image" href="img/slide002.jpg" title='<h2>Sur le tournage de "Deephan" de Jacques Audiard</h2><p>Crédit Image : VALERY HACHE / AFP</p>'></a>
        ...
        <div class="item theme2 date2 date theme shadow-bottom photo">
          <a id="photo3" class="chocolat-image" href="img/slide001.jpg" title='<h2>Sur le tournage de "Deephan" de Jacques Audiard</h2><p>Crédit Image : VALERY HACHE / AFP</p>'></a>
          <img src="http://dummyimage.com/640x404/000/fff.png" srcset="http://dummyimage.com/640x404/ddd/000.png 1x, http://dummyimage.com/1280x808/ddd/000.png 2x" alt="">
          <div class="picto"></div>
          <div class="info">
            <div class="vCenter">
        ...
        <div class="item theme2 date theme portrait shadow-bottom photo">
          <a id="photo4" class="chocolat-image" href="img/slide002.jpg" title='<h2>Sur le tournage de "Deephan" de Jacques Audiard</h2><p>Crédit Image : VALERY HACHE / AFP</p>'></a>
          <img src="http://dummyimage.com/320x404/3498db/.png" srcset="http://dummyimage.com/320x404/3498db/.png 1x, http://dummyimage.com/640x808/000/fff.png 2x" alt="">
          <div class="picto"></div>
          <div class="info">
            <div class="vCenter">
        ...
        <div class="item theme2 theme shadow-bottom photo">
          <a id="photo5" class="chocolat-image" href="img/slide002.jpg" title='<h2>Sur le tournage de "Deephan" de Jacques Audiard</h2><p>Crédit Image : VALERY HACHE / AFP</p>'></a>
          <img src="http://dummyimage.com/640x404/000/fff.png" srcset="http://dummyimage.com/640x404/ddd/000.png 1x, http://dummyimage.com/1280x808/ddd/000.png 2x" alt="">
          <div class="picto"></div>
          <div class="info">
            <div class="vCenter">
        ...
        <div class="item theme2 date1 theme shadow-bottom photo">
          <a id="photo6" class="chocolat-image" href="img/slide002.jpg" title='<h2>Sur le tournage de "Deephan" de Jacques Audiard</h2><p>Crédit Image : VALERY HACHE / AFP</p>'></a>
          <img src="http://dummyimage.com/640x404/000/fff.png" srcset="http://dummyimage.com/640x404/ddd/000.png 1x, http://dummyimage.com/1280x808/ddd/000.png 2x" alt="">
          <div class="picto"></div>
          <div class="info">
            <div class="vCenter">
        ...
        <div class="item theme1 date2 theme shadow-bottom photo">
          <a id="photo7" class="chocolat-image" href="img/slide002.jpg" title='<h2>Sur le tournage de "Deephan" de Jacques Audiard</h2><p>Crédit Image : VALERY HACHE / AFP</p>'></a>
        ...
        <div class="item theme2 date theme shadow-bottom">
          <a id="photo8" class="chocolat-image" href="img/slide002.jpg" title='<h2>Sur le tournage de "Deephan" de Jacques Audiard</h2><p>Crédit Image : VALERY HACHE / AFP</p>'></a>
          <img src="http://dummyimage.com/640x404/000/fff.png" srcset="http://dummyimage.com/640x404/ddd/000.png 1x, http://dummyimage.com/1280x808/ddd/000.png 2x" alt="">
          <div class="picto"></div>
          <div class="info">
            <div class="vCenter">
        ...
        <div class="item theme2 date1 theme portrait shadow-bottom">
          <a id="photo9" class="chocolat-image" href="img/slide002.jpg" title='<h2>Sur le tournage de "Deephan" de Jacques Audiard</h2><p>Crédit Image : VALERY HACHE / AFP</p>'></a>
          <img src="http://dummyimage.com/320x404/3498db/.png" srcset="http://dummyimage.com/320x404/3498db/.png 1x, http://dummyimage.com/640x808/000/fff.png 2x" alt="">
          <div class="picto"></div>
          <div class="info">
            <div class="vCenter">
