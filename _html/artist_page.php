    ...
    <div id="main" class="single-article artist loading">
      <div class="content-article">
        <div class="container">
          ...
          <div class="single-photo">
            <div class="photo-container">
              <img src="img/artist/photo-artiste.jpg" alt="" />
            </div>
          </div>
          <div class="small-container">
            <div class="biographie">
              <h2 class="title title-cat-artist">Biographie</h2>
              <p class="paragraph">
                Né à Détroit (Etats-Unis) en 1939. Diplômé de la Hofstra University de New York et titulaire d'un Master of Fine Arts d'UCLA, section cinéma. Depuis 1979 : 1979 : Apocalypse Now 1982 : One from the Heart 1983 : The Outsiders 1983 : Rumble Fish 1984 : The Cotton Club 1986 : Peggy Sue Got Married 1987 : Gardens of Stone 1988 : Tucker: The Man and His Dream 1989 : New York Stories 1990 : The Godfather: Part III 1992 : Dracula 1996 : Jack 1997 : John Grisham's The Rainmaker</p>
            </div>
              <h2  class="title title-art-artist">Films présentés à Cannes</h2>
              <div class="contain-films-list">
                ...
                <div class="item">
                  ...
                  <div class="content-text">
                    <span class="item-title">Apocalypse now</span>
                    <span class="item-sub-title">(work in progress)</span>
        ...
        <div class="realisateurs">
          <h1 class="title">Réalisateurs</h1>
          <div id="slide-artist">

            <div class="item first"><figure><img src="img/artist/res1.jpg" alt="Owl Image"><figcaption><span class="name">Toddhaynes</span><span class="rank">Réalisateur</span></figcaption></figure></div>
