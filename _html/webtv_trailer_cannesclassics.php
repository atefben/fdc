    ...
    <div id="main" class="webtv webtv-ba loading">
     <div class="bandeau">
				...
				<ul class="sub-nav-list">
					...
					<li><a href="webtv_trailer_cannesclassics.php" data-url="webtv_trailer_cannesclassics.php" class="active ajax">Cannes classics</a></li>
			...
			<div class="content-webtv">
						<?php include('webtv_trailer_cannesclassics_detail.php'); ?>
			</div>
    </div>
