...
use Base\CoreBundle\Entity\FDCPageParticipateWidget;
use Symfony\Component\Form\FormBuilderInterface;

/**
 * FDCPageParticipateWidgetPictoType class.
 *
 * \@extends NewsWidgetType
 * @author  Antoine Mineau <a.mineau@ohwee.fr>
 * \@company Ohwee
 */
class FDCPageParticipateWidgetPictoType extends FDCPageParticipateWidgetType
{

    /**
     * dataClass
     *
     * (default value: 'Base\CoreBundle\Entity\FDCPageParticipateWidgetPicto')
     *
     * @var string
     * @access protected
     */
    protected $dataClass = 'Base\CoreBundle\Entity\FDCPageParticipateWidgetPicto';
    ...
    {
        return 'fdc_page_participate_widget_picto_type';
    }
}