...
class MediaListener
{
    ...
    protected function createAmazonVideoJob(MediaVideoTranslation $mediaVideo, $args)
    {
		...
		error_log(print_r(\Doctrine\Common\Util\Debug::export($nameWebm, 6),1));
		error_log(print_r(\Doctrine\Common\Util\Debug::export($medias_1, 6),1));
		error_log(print_r(\Doctrine\Common\Util\Debug::export($medias_2, 6),1));
