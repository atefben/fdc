...
use Base\CoreBundle\Entity\FDCPageMediatheque;
use Base\CoreBundle\Entity\FDCPageMediathequeTranslation;
...
class FDCPageMediathequeAdmin extends Admin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ->add('translations', 'a2lix_translations', array(
                ...
                'fields'             => array(
                    ...
                    'status'         => array(
                        ...
                        'translation_domain'        => 'BaseAdminBundle',
                        'field_type'                => 'choice',
                        'choices'                   => FDCPageMediathequeTranslation::getStatuses(),
            ...
            ->add('translateOptions', 'choice', array(
                'choices' => FDCPageMediatheque::getAvailableTranslateOptions(),
                'translation_domain' => 'BaseAdminBundle',
                'multiple' => true,
                'expanded' => true
            ))
            ->add('priorityStatus', 'choice', array(
                'choices'                   => FDCPageMediatheque::getPriorityStatuses(),
                'choice_translation_domain' => 'BaseAdminBundle',
            ))
