...
class MdfProgramIndustryDispatchAdmin extends Admin
{
            ...
            ->add('translations', 'a2lix_translations', array(
                ...
                'fields' => array(
                    ...
                    'status'            => array(
                        ...
                        'translation_domain'        => 'BaseAdminBundle',
                        'field_type'                => 'choice',
                        'choices'                   => ProgramIndustryDispatchTranslation::getStatuses(),
                        'choice_translation_domain' => 'BaseAdminBundle',
                    )
                )
            ))
            ->add('dispatchWidgets', 'infinite_form_polycollection', array(
                'label'        => false,
                'types'        => array(
                    'program_industry_dispatch_widget_type',
                ),
                'allow_add'    => true,
                'allow_delete' => true,
                'prototype'    => true,
