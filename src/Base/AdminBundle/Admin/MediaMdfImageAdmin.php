...
/**
 * MediaMdfImageAdmin class.
 *
 * \@extends Admin
 */
class MediaMdfImageAdmin extends Admin
{
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            ->add('legend', null, array(
                ...
                'template' => 'BaseAdminBundle:MediaMdfImage:list_legend.html.twig',
            ))
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ->add('translations', 'a2lix_translations', array(
                ...
                'fields' => array(
                    ...
                    'status'         => array(
                        ...
                        'translation_domain'        => 'BaseAdminBundle',
                        'field_type'                => 'choice',
                        'choices'                   => MediaMdfImageTranslation::getStatuses(),
            ...
            ->add('priorityStatus', 'choice', array(
                'choices'                   => MediaMdfImage::getPriorityStatuses(),
                'choice_translation_domain' => 'BaseAdminBundle'
            ))
            ->end()
        ;
