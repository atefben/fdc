...
use FDC\MarcheDuFilmBundle\Entity\MediaMdfAudio;
...
/**
 * MediaMdfAudioAdmin class.
 *
 * \@extends Admin
 */
class MediaMdfAudioAdmin extends Admin
{
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            ->add('title', null, array(
                'label'    => 'list.label_title_audio',
                'template' => 'BaseAdminBundle:MediaMdfAudio:list_title.html.twig'
            ))
            ->add('theme')
            ...
            ->add('priorityStatus', 'choice', array(
                'choices'   => MediaMdfAudio::getPriorityStatusesList(),
                'catalogue' => 'BaseAdminBundle'
            ))
            ->add('state', null, array(
                'label'              => 'list.media_video.label_encoding_state',
                'template'           => 'BaseAdminBundle:MediaMdfAudio:list_state.html.twig',
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ->add('translations', 'a2lix_translations', array(
                ...
                'fields'             => array(
                    ...
                    'status'           => array(
                        ...
                        'translation_domain'        => 'BaseAdminBundle',
                        'field_type'                => 'choice',
                        'choices'                   => MediaMdfAudioTranslation::getStatuses(),
            ...
            ->add('translateOptions', 'choice', array(
                'choices'            => MediaMdfAudio::getAvailableTranslateOptions(),
                'translation_domain' => 'BaseAdminBundle',
                'multiple'           => true,
                'expanded'           => true
            ))
            ->add('priorityStatus', 'choice', array(
                'choices'                   => MediaMdfAudio::getPriorityStatuses(),
                'choice_translation_domain' => 'BaseAdminBundle',
                'multiple'                  => false
            ))
            ->end()
