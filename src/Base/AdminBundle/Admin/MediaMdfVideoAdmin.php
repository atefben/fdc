...
class MediaMdfVideoAdmin extends Admin
{
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            ->add('title', null, array(
                ...
                'template'           => 'BaseAdminBundle:MediaMdfVideo:list_title.html.twig',
                'translation_domain' => 'BaseAdminBundle',
            ))
            ->add('theme')
            ->add('webTv', null, array(
            ...
            ->add('priorityStatus', 'choice', array(
                'choices'   => MediaMdfVideo::getPriorityStatusesList(),
                'catalogue' => 'BaseAdminBundle',
            ))
            ->add('statusMain', 'choice', array(
                'choices'   => MediaMdfVideoTranslation::getStatuses(),
                'catalogue' => 'BaseAdminBundle',
            ))
            ->add('state', null, array(
                'label'              => 'list.media_video.label_encoding_state',
                'template'           => 'BaseAdminBundle:MediaMdfVideo:list_state.html.twig',
                'translation_domain' => 'BaseAdminBundle',
            ))
...
//            $amazonRemoteFileAttrs = ($isTranslatorEnEsCh) ? array('readonly' => 'readonly') : array();
        ...
        $formMapper
            ...
            ->add('translateOptions', 'choice', array(
                'choices'            => MediaMdfVideo::getAvailableTranslateOptions(),
                'translation_domain' => 'BaseAdminBundle',
                'multiple'           => true,
                'expanded'           => true,
            ))
            ->add('priorityStatus', 'choice', array(
                'choices'                   => MediaMdfVideo::getPriorityStatuses(),
                'choice_translation_domain' => 'BaseAdminBundle',
            ))
