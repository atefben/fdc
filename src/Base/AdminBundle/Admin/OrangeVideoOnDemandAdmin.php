...
class OrangeVideoOnDemandAdmin extends Admin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ...
            ->add('video', 'sonata_type_model_list', array(
                'label' => 'form.orange_vod.label_video',
                'help' => 'form.orange_vod.helper_video',
                'translation_domain' => 'BaseAdminBundle',
            ))
            
            ->add('header', 'sonata_type_model_list', array(
                'label' => 'form.orange_vod.label_header_image',
                'help' => 'form.orange_vod.helper_header_image',
                'translation_domain' => 'BaseAdminBundle',
            ))
