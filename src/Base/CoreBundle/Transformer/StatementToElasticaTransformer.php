...
/**
 * Description of StatementToElasticaTransformer
 *
 * @author ohwee
 */
class StatementToElasticaTransformer extends ModelToElasticaAutoTransformer implements ModelToElasticaTransformerInterface
{
    /**
