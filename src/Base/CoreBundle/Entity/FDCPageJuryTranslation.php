...
/**
 * FDCPageJuryTranslation
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Base\CoreBundle\Repository\FDCPageJuryTranslationRepository")
 * @ORM\HasLifecycleCallbacks
 */
class FDCPageJuryTranslation implements TranslateChildInterface
{
    use Time;
    use Translation;
    use TranslateChild;
