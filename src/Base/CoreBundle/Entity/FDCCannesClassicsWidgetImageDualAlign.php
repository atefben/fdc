...
/**
 * FDCCannesClassicsWidgetImageDualAlign
 *
 * @ORM\Table()
 * @ORM\Entity
 * @ORM\HasLifecycleCallbacks()
 */
class FDCCannesClassicsWidgetImageDualAlign extends FDCCannesClassicsWidget
{
    /**
     ...
     * @return FDCCannesClassicsWidgetImageDualAlign
     */
