...
/**
 * InfoFilmProjectionAssociated
 *
 * @ORM\Table()
 * @ORM\Entity
 * @ORM\HasLifecycleCallbacks()
 */
class InfoFilmProjectionAssociated
{
    use Time;
     ...
     * @var Info
     *
     * @ORM\ManyToOne(targetEntity="Info", inversedBy="associatedProjections")
     */
    protected $info;
     ...
     * @return InfoFilmProjectionAssociated
     */
