...
class ProgramIndustryDispatchWidgetType extends AbstractType
{
    /**
     * @var string
     */
    protected $dataClass = 'FDC\MarcheDuFilmBundle\Entity\ProgramIndustryDispatchWidget';
    ...
    {
        return 'program_industry_dispatch_widget_type';
    }
}
