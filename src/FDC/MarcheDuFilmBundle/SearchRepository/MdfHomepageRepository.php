...
class MdfHomepageRepository extends SearchRepository
{
    public function findWithCustomQuery($_locale, $searchTerm)
    {
        ...
        if($searchTerm) {
            ...
            $stringQuery
                ...
                ->addShould($this->getServicesQuery($_locale, $searchTerm))
            ;
    ...
    private function getServicesQuery($_locale, $searchTerm)
    {
