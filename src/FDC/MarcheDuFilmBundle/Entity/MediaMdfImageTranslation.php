...
/**
 * @ORM\Entity(repositoryClass="FDC\MarcheDuFilmBundle\Repository\MediaMdfImageTranslationRepository")
 * @ORM\HasLifecycleCallbacks()
 */
class MediaMdfImageTranslation implements TranslateChildInterface
{
    use Seo;
    use Time;
    use Translation;
