...
class CcmLabelSectionContentTwoColumnsType extends CcmLabelSectionContentType
{
    /**
     * @var string
     */
    protected $dataClass = 'FDC\CourtMetrageBundle\Entity\CcmLabelSectionContentTwoColumns';
    ...
    {
        return 'ccm_label_section_content_two_columns_type';
    }
}
