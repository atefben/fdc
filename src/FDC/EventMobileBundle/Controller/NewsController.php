...
class NewsController extends Controller
{
    ...
    /**
     * @Route("/")
     * @Template("FDCEventMobileBundle:News:home.html.twig")
     */
     ...
     * @Template("FDCEventMobileBundle:News:widgets/article-home-ajax.html.twig")
     ...
     * @Template("FDCEventMobileBundle:News:main.html.twig")
     * @param $slug
     * @return array
     */
     ...
     * @Route("/articles")
     *
     * @Template("FDCEventMobileBundle:News/list:article.html.twig")
     */
    public function getArticlesAction(Request $request)
    {
        ...
        foreach ($newsArticles as $key => $newsArticle) {
            ...
            if ($isPublished) {
                ...
                if ($newsArticle->getTheme() && !in_array($newsArticle->getTheme()->getId(), $filters['themes']['id'])) {
     ...
     *
     * @Route("/photos")
     * @Template("FDCEventMobileBundle:News/list:photo.html.twig")
     */
    ...
    /**
     * @Route("/videos")
     * @Template("FDCEventMobileBundle:News/list:video.html.twig")
     */
    ...
    /**
     * @Route("/audios")
     * @Template("FDCEventMobileBundle:News/list:audio.html.twig")
     */
