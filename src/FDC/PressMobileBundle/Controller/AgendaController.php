 ...
 * @package FDC\PressMobileBundle\Controller
 */
class AgendaController extends Controller
{
    ...
    public function schedulingAction(Request $request)
    {
        ...
        $waitingPage = $this->isWaitingPagePress($request, 'fdc_press_agenda_scheduling');
        if ($waitingPage) {
            return $waitingPage;
        }
    ...
    /**
     * @Route("/agenda")
     * @Template("FDCPressMobileBundle:Agenda:agenda.html.twig")
     *
     */
    ...
    /**
     * @Route("/room")
     * @Template("FDCPressMobileBundle:Agenda:room.html.twig")
     *
     */
