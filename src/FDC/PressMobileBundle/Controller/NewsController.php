...
class NewsController extends Controller
{
    /**
     * @Route("/")
     * @Template("FDCPressMobileBundle:News:home.html.twig")
     ...
     * @Template("FDCPressMobileBundle:News:main.html.twig")
     * @param $slug
     * @param $format
     * @param $type
     * @return array
     ...
     *
     * @Route("/press-actu")
     * @Template("FDCPressMobileBundle:News:list.html.twig")
     * @return array
     */
     ...
     * @Template("FDCPressMobileBundle:News:list/article-list-ajax.html.twig")
     * @return array
     */
