  ...
  $('body').on('click', '.chocolat-wrapper .thumb', function(e) {
    ...
    //window.location.hash = $(this).data('id');
      ...
      setTimeout(function() {
        ...
        console.log(slideshow.api().current());
        $('.chocolat-wrapper .thumb').removeClass('active');
      ...
      var x0=0 , y0=0, newPan=false, x_start = $('.chocolat-content').position().left, y_start = $('.chocolat-content').position().top;
      console(x_start,y_start);
